class PendaftaransController < ApplicationController
  before_action :set_pendaftaran, only: %i[ show edit update destroy ]

  # GET /pendaftarans or /pendaftarans.json
  def index
    @pendaftarans = Pendaftaran.all
  end

  # GET /pendaftarans/1 or /pendaftarans/1.json
  def show
  end
  ...
  # POST /pendaftarans or /pendaftarans.json
  def create
  ...
  # PATCH/PUT /pendaftarans/1 or /pendaftarans/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /pendaftarans/1 or /pendaftarans/1.json
  def destroy
    @pendaftaran.destroy
    respond_to do |format|
